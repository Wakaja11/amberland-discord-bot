...
FORMS = {
    "login": ("Проблема со входом", (("Ваш никнейм", True), ("Что именно не работает?", True), ("Когда возникла проблема?", False), ("Скриншоты/видео (если есть)", False))),
    "player": ("Жалоба на игрока", (("Ваш никнейм", True), ("Никнейм нарушителя", True), ("Что случилось?", True), ("Скриншоты/видео (если есть)", False))),
    "territory": ("Вопрос о территории", (("Ваш никнейм", True), ("Название территории или координаты", True), ("Ваш вопрос", True), ("Скриншоты/видео (если есть)", False))),
    "donation": ("Проблема с донатом", (("Ваш никнейм", True), ("Что было приобретено?", True), ("Описание проблемы", True), ("Номер платежа (если есть)", False), ("Скриншоты оплаты (если есть)", False))),
    "admin": ("Жалоба на администратора", (("Ваш никнейм", True), ("Никнейм администратора", True), ("Что случилось?", True), ("Скриншоты/видео (если есть)", False))),
    "other": ("Другое", (("Ваш никнейм", True), ("Тема обращения", True), ("Опишите ситуацию", True), ("Скриншоты/видео (если есть)", False))),
}
