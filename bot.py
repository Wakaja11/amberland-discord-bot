...
FORMS = {
    ...
    "server": ("Проблема с сервером", (("Ваш никнейм", True), ("Описание проблемы", True), ("Какие действия привели к возникновению проблемы", True), ("Скриншоты/видео (если есть)", False))),
    "discord": ("Проблема с дискордом", (("Ваш никнейм", True), ("Описание проблемы", True), ("Что случилось?", True), ("Скриншоты/видео (если есть)", False))),
...
class HelpForm(discord.ui.Modal):
    def __init__(self, kind: str) -> None:
        ...
        long = {"Что случилось?", "Описание проблемы", "Какие действия привели к возникновению проблемы"}
